angular.module('angular-meteor-demo').directive('animSidebar', function(UtilsService, AnimSidebarService){
...
angular.module("angular-meteor-demo").factory("AnimSidebarService", function(){
