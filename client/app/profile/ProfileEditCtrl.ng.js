angular.module('angular-meteor-demo').controller('ProfileEditCtrl', function ($rootScope, $scope, $meteor, $timeout, CollectionService, SecurityService, SessionService, MapService, AnimToasterNotificationService) {
