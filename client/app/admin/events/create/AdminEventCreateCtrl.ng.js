angular.module('angular-meteor-demo').controller('AdminEventCreateCtrl', function ($scope, $meteor, $stateParams, $state, CollectionService, AnimToasterNotificationService, SessionService) {
