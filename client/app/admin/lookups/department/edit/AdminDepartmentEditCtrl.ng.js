angular.module('angular-meteor-demo').controller('AdminDepartmentEditCtrl', function ($scope, $meteor, $stateParams, $state, CollectionService, AnimToasterNotificationService) {
