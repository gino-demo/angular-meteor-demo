angular.module('angular-meteor-demo').controller('AdminUserEditCtrl', function ($scope, $meteor, $stateParams, $state, CollectionService, AnimToasterNotificationService) {
